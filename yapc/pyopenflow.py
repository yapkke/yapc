...
class ofp_action_vlan_vid:
    ...
    def __init__(self):
        ...
        self.len = OFP_ACTION_SET_VLAN_VID_BYTES
        self.vlan_vid = 0
        self.pad= [0,0]
...
class ofp_action_output:
    ...
    def __init__(self):
        ...
        self.len = OFP_ACTION_OUTPUT_BYTES
        self.port = 0
        self.max_len = 0
...
class ofp_action_dl_addr:
    ...
    def __init__(self):
        ...
        """
        self.type = 0
        self.len = OFP_ACTION_DL_ADDR_BYTES
...
class ofp_action_nw_addr:
    ...
    def __init__(self):
        ...
        """
        self.type = 0
        self.len = OFP_ACTION_NW_ADDR_BYTES
        self.nw_addr = 0
...
class ofp_action_vlan_pcp:
    ...
    def __init__(self):
        ...
        self.len = OFP_ACTION_SET_VLAN_PCP_BYTES
        self.vlan_pcp = 0
        self.pad= [0,0,0]
